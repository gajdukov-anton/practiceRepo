...
/* harmony import */ let __WEBPACK_IMPORTED_MODULE_0__barrier_js__ = __webpack_require__(1);
let LEFT = '0';
let RIGHT = '180';
let TOP = '90';
let BOTTOM = '-90';
...
let createVector = (coordinates, _position) => {
    let deltha = {
        x: 0,
        y: 0
    };
...
let Boat = function (containerId, id, frameSize, bulletCreationHandler, checker) {
    ...
    this.render = () => {
        ...
        if (checker === true && this._canRotate === true) {
            let grad = {
                x: this._coordinates.x - this._position.left,
                y: this._coordinates.y - this._position.top,
            };
            ...
            this._boatDomElement.style.transform = 'rotate(' + gradus + 'deg)';
            this._canRotate = false
        }
    };
...
let Game = function () {
    ...
    let barrier = new __WEBPACK_IMPORTED_MODULE_0__barrier_js__["a" /* Barrier */]('barrier');
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return Barrier; });
